...
Pianod.prototype.changePlayback = function(playbackType) {
	...
	if (currentPlayback !== playbackType) {
		...
		if (
			(currentPlayback === this.PLAYBACK_TYPES.BETWEEN_SONGS || currentPlayback === this.PLAYBACK_TYPES.STOPPED) && playbackType === this.PLAYBACK_TYPES.PLAYING) {
